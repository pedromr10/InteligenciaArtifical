...
a = img_gray.max()
_, thresh = cv2.threshold(img_gray, a/2*1.9, a,cv2.THRESH_BINARY_INV) #alterar aqui


tamanhoKernel = 4                                                     #alterar aqui
...
edges_gray = cv2.Canny(image=img_gray, threshold1=a/1.5, threshold2=a/5) #alterar aqui
# Detecção borda com Canny (com blurry)
edges_blur = cv2.Canny(image=img_blur, threshold1=a/1.5, threshold2=a/2) #alterar aqui
